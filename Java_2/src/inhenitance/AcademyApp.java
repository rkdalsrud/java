...
public class AcademyApp {
	public static void main(String[] args) {
		...
		AcademyPerson[] persons =new AcademyPerson[5]; //부모
		
		persons[0]=new AcademyStudent(100,"rkdrk","웹개발");
		persons[1]=new AcademyInstructor(200,"ㅁㅁㅁ","개발");
		persons[2]=new AcademyStaff(100,"rkd","웹발");
...
public class AcademyApp {
	public static void main(String[] args) {
		...
		*/
		...
		//자식클래스의 메소드 호출 가능
		/*
		persons[0]=new AcademyStudent(1000, "홍길동", "웹개발자 과정");-부모객체가 먼저 생성하기 떄문에 맨앞이 persons
		...
		for(AcademyPerson person : persons) {
			...
			person.display();-display는 오버라이드되어있어 일시적으로 자식객체가 호출된다.
			System.out.println("==========================================================");
		}
		*/
